...
//            from(components["kotlin"])
            ...
            pom {
                name.set("pdf_printer")
                description.set("打印pdf文件")
                url.set("https://github.com/devzwy/pdf_printer")

                scm {
                    url.set("https://github.com/devzwy/pdf_printer.git")  // 添加 SCM URL
                    connection.set("scm:git:https://github.com/devzwy/pdf_printer.git")
                    developerConnection.set("scm:git:https://github.com/devzwy/pdf_printer.git")
                }
